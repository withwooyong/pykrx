...
class TestStockTradingValueByInvestor:
...
class TestStockTradingValueByDate:
    def test_trading_value_is_same_0(self):
...
class TestStockTradingVolumeByDate:
    def test_trading_value_is_same_0(self):
        #            기관합계 기타법인    개인 외국인합계  전체
        # 날짜
...
class TestStockExhaustionRatesOfForeignInvestmentByDate:
    def test_kospi_for_specific_day(self):
