...
class TestStockMarketCap(unittest.TestCase):
    ...
    def test_get_market_cap_by_date_with_string_dates(self):
        ...
        with patch('pykrx.website.krx.get_market_cap_by_date') as mock_krx:
            ...
            self.assertIn('시가총액', result.columns)
            self.assertIn('거래량', result.columns)
            self.assertIn('거래대금', result.columns)
            self.assertIn('상장주식수', result.columns)
    ...
    def test_get_market_cap_by_date_with_datetime_dates(self):
        ...
        with patch('pykrx.website.krx.datetime2string') as mock_datetime2string:
            with patch('pykrx.website.krx.get_market_cap_by_date') as mock_krx:
                ...
                result = get_market_cap_by_date(start_date, end_date, "005930")
    ...
    def test_get_market_cap_by_date_with_dash_dates(self):
        ...
        with patch('pykrx.website.krx.get_market_cap_by_date') as mock_krx:
            ...
            result = get_market_cap_by_date("2024-01-15", "2024-01-15", "005930")
    ...
    def test_get_market_cap_by_date_with_freq(self):
        ...
        with patch('pykrx.website.krx.get_market_cap_by_date') as mock_krx:
            ...
            self.assertEqual(result.iloc[0]['시가총액'], 1000000)  # 마지막 시가총액
            self.assertEqual(result.iloc[0]['거래량'], 30000)     # 거래량 합계
            self.assertEqual(result.iloc[0]['거래대금'], 3000000)  # 거래대금 합계
            self.assertEqual(result.iloc[0]['상장주식수'], 10000)  # 마지막 상장주식수
    ...
    def test_get_market_cap_by_ticker_with_ascending(self):
        ...
        with patch('pykrx.website.krx.get_market_cap_by_ticker') as mock_krx:
            ...
            result = get_market_cap_by_ticker("20240115", "KOSPI", acending=True)
    ...
    def test_get_market_cap_by_ticker_with_datetime(self):
        ...
        with patch('pykrx.website.krx.datetime2string') as mock_datetime2string:
            with patch('pykrx.website.krx.get_market_cap_by_ticker') as mock_krx:
                ...
                result = get_market_cap_by_ticker(test_date, "KOSPI")
    ...
    def test_get_market_cap_function_dispatch(self):
        ...
        with patch('pykrx.stock.stock_market_cap.get_market_cap_by_date') as mock_by_date:
            with patch('pykrx.stock.stock_market_cap.get_market_cap_by_ticker') as mock_by_ticker:
